...
RSpec.describe TurmasController, :type => :controller do
  ...
  let(:valid_attributes) {
    FactoryGirl.build(:turma).attributes.symbolize_keys
  }
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created turma as @turma" do
        post :create, {:turma => valid_attributes}, valid_session
        expect(assigns(:turma)).to be_a(Turma)
        expect(assigns(:turma)).to be_persisted
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested turma" do
        turma = Turma.create! valid_attributes
        put :update, {:id => turma.to_param, :turma => new_attributes}, valid_session
        turma.reload
        expect(assigns(:turma).attributes.symbolize_keys[:dt_fim]).to eq(new_attributes[:dt_fim])
      end
